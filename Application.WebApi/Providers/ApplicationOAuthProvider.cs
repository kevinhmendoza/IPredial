...
namespace Application.WebApi.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            {
                context.SetError("invalid_grant", "El usuario no ha confirmado el correo!!.");
                return;
            }
            ...
            AuthenticationProperties properties = CreateProperties(user.UserName, user.NombreCompleto);
        ...
        public static AuthenticationProperties CreateProperties(string userName, string nombreTercero)
        {
